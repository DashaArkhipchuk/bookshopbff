...
public class CreateBookController {
    ...
    public ModelAndView createBook(@ModelAttribute BookWithAuthorIdDto book) throws Exception {
        FullAuthorDto author = authorService.getAuthor(book.getAuthorId());
        if (author!=null){

            CreateBookRequest createBookRequest = BookRequestMapper.mapBookToCreateBookRequest(bookWithAuthorIdDtoMapper.mapBookBookWithAuthorIdDtoToBook(book));
